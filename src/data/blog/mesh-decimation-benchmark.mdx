...
thumbnail: 'https://ik.imagekit.io/8ieg70pvks/mesh-decimation.jpg'
related: []
---
...
<a href="https://github.com/ahnafnafee/mesh-decimation-benchmark" target="_blank" rel="noopener noreferrer">GitHub Repository</a> · <a href="https://github.com/ahnafnafee/mesh-decimation-benchmark/blob/main/Report/Ahnaf-AnNafee-CS700-Project-Report.pdf" target="_blank" rel="noopener noreferrer">Full Report (PDF)</a>
  ...
  <table className="min-w-full text-sm">
    <thead>
      <tr className="border-b border-gray-200 dark:border-gray-700">
        ...
        <th className="px-4 py-3 text-left font-semibold">Mesh Type</th>
        <th className="px-4 py-3 text-left font-semibold">Time (s)</th>
        <th className="px-4 py-3 text-left font-semibold">Hausdorff Dist.</th>
      </tr>
    </thead>
    <tbody>
      <tr className="border-b border-gray-100 dark:border-gray-800">
        <td className="px-4 py-3 font-medium">Clustering</td>
        <td className="px-4 py-3">Clean CAD (ModelNet40)</td>
        <td className="px-4 py-3">0.005 ± 0.004</td>
        <td className="px-4 py-3">0.006 ± 0.006</td>
      </tr>
      <tr className="border-b border-gray-100 dark:border-gray-800">
        <td className="px-4 py-3 font-medium">Clustering</td>
        <td className="px-4 py-3">Organic (Thingi10k)</td>
        <td className="px-4 py-3">0.032 ± 0.062</td>
        <td className="px-4 py-3">0.013 ± 0.012</td>
      </tr>
      <tr className="border-b border-gray-100 dark:border-gray-800">
        <td className="px-4 py-3 font-medium">QEM</td>
        <td className="px-4 py-3">Clean CAD (ModelNet40)</td>
        <td className="px-4 py-3">0.259 ± 0.178</td>
        <td className="px-4 py-3">0.034 ± 0.061</td>
      </tr>
      <tr>
        <td className="px-4 py-3 font-medium">QEM</td>
        <td className="px-4 py-3">Organic (Thingi10k)</td>
        <td className="px-4 py-3">1.290 ± 1.718</td>
        <td className="px-4 py-3">0.006 ± 0.007</td>
      </tr>
    </tbody>
  </table>
</div>
...
- [Full Report (PDF)](https://github.com/ahnafnafee/mesh-decimation-benchmark/blob/main/Report/Ahnaf-AnNafee-CS700-Project-Report.pdf) — Complete paper
- [Detailed Methodology](https://github.com/ahnafnafee/mesh-decimation-benchmark/blob/main/DETAILS.md) — Mathematical foundations
- [Results Documentation](https://github.com/ahnafnafee/mesh-decimation-benchmark/blob/main/RESULTS.md) — Statistical analysis

### Citation

```text
@misc{nafee2024meshdecimation,
