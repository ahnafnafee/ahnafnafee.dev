...
thumbnail: '/images/songmirror-social.png'
related: []
---
...
<figure className='not-prose my-6'>
  <img
    ...
    alt='Animated demo of SongMirror connecting services, setting up a one-way and bidirectional sync, and running a live playlist transfer across Spotify, Apple Music, and YouTube Music'
...
<figure className='not-prose my-6'>
  <img
    ...
    alt='The SongMirror Accounts page connecting Spotify with OAuth, Apple Music with a token paste, YouTube Music with a device code, and Jellyfin with an API key'
    className='w-full rounded-lg border border-gray-200 dark:border-gray-800'
  />
  <figcaption className='mt-2 text-center text-sm text-gray-500 dark:text-gray-400'>
...
<figure className='not-prose my-6'>
  <img
    ...
    alt='The SongMirror sync setup wizard choosing between a one-way source-of-truth direction and a bidirectional N-way sync'
    className='w-full rounded-lg border border-gray-200 dark:border-gray-800'
  />
  <figcaption className='mt-2 text-center text-sm text-gray-500 dark:text-gray-400'>
...
<figure className='not-prose my-6'>
  <img
    ...
    alt='The SongMirror dashboard showing sync status, configured one-way and bidirectional sync jobs, a live activity feed, and connected Spotify, Apple Music, YouTube Music, and Jellyfin services'
    loading='lazy'
    className='w-full rounded-lg border border-gray-200 dark:border-gray-800'
  />
  <figcaption className='mt-2 text-center text-sm text-gray-500 dark:text-gray-400'>
