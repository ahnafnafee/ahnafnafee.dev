...
graph TD
    ...
    SNAP --> Y["Reconcile YouTube Music<br/>(ytmusicapi)"]
...
The source is on [GitHub](https://github.com/ahnafnafee/spotify-playlist-mirror-sync), MIT-licensed. The default is a dry run: it prints every add and remove it _would_ make and writes nothing, so you can point it at your own library and read the whole plan before it touches a single playlist. Stars, issues, and PRs all welcome.
