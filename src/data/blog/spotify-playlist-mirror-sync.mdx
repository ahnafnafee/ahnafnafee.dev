...
<figure className='not-prose my-6'>
  <img
    src='/images/omni-sync-demo.gif'
    alt='Animated demo of Omni Sync connecting services, setting up a one-way and bidirectional sync, and running a live playlist transfer across Spotify, Apple Music, and YouTube Music'
    className='w-full rounded-lg border border-gray-200 dark:border-gray-800'
  />
  <figcaption className='mt-2 text-center text-sm text-gray-500 dark:text-gray-400'>
    Omni Sync end to end: connect a service, build a sync, and transfer a playlist, with every match streaming live.
  </figcaption>
</figure>
