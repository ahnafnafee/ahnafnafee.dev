...
<div className='my-8 flex justify-center'>
  <video
    ...
    controls
    preload='metadata'
    aria-label='Rally promo video walking through the live court map, a court status card, a pickup game with GPS check-in, and a player profile'
  />
</div>
