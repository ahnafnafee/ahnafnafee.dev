...
The name fields are the name of our website, we can name it whatever we want, fill in the domain field with your website's domain that you want to monitor, e.g: `ahnafnafee.dev`, and click **save**.
