...
image: '/images/songmirror-social.png'
...
<div className='not-prose my-6 grid grid-cols-1 gap-3 sm:grid-cols-2'>
  <img
    ...
    alt='SongMirror dashboard showing sync status, configured sync jobs, a live activity feed, and connected Spotify, Apple Music, YouTube Music, and Jellyfin services'
    loading='lazy'
    className='w-full rounded-xl border border-gray-200 dark:border-gray-800'
  />
  <img
    src='/images/songmirror-wizard.png'
    alt='The SongMirror setup wizard choosing a one-way or bidirectional N-way direction for a sync job'
    loading='lazy'
    className='w-full rounded-xl border border-gray-200 dark:border-gray-800'
  />
  <img
