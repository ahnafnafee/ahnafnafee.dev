...
image: 'https://ik.imagekit.io/8ieg70pvks/portfolio/tva_og.png?ik-sdk-version=javascript-1.4.3&updatedAt=1670981729993'
stack: ['unity', 'csharp', 'photoshop', "figma", "illustrator", "maya", "perforce"]
link: { github: 'https://github.com/ahnafnafee/TheVoidAbove', live: 'https://voidgaminginc.wixsite.com/thevoidabove' }
---
...
> Code for `OnScreen GUI Indicator`
