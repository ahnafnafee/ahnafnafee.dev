...
<div className='not-prose my-6 grid grid-cols-1 gap-3 sm:grid-cols-2'>
  ...
  <img
    ...
    alt='Transferring a Spotify playlist to Apple Music with a live progress bar, an added-so-far counter, pause and stop controls, and a panel to resolve unmatched tracks'
    loading='lazy'
    className='w-full rounded-xl border border-gray-200 dark:border-gray-800'
  />
  <img
